...
print("Recherche du fichier de restauration le plus récent " )
...
try:
    ...
    print("L'archive extraite avec succès.")
    ...
    if not dump_files:
        print("Aucun fichier .dump n'a été trouver dans l'archive.")
        logger.error("Erreur : Aucun fichier .dump n'a été trouver dans l'archive.")
        exit()
    ...
    # suppression du dossier d'extration
